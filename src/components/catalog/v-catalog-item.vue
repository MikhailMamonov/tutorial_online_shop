<template>
  <div class="v-catalog-item">
    <v-popup
      ...
      @rightBtnClickAction="onAddToCart"
    ...
    >
      <div>
        ...
        <p class="v-catalog-item__price">{{ toFix }} Р</p>
    ...
    <button class="v-catalog-item__add-to-cart-btn btn" @click="onAddToCart">
      Add to Cart
    </button>
  </div>
</template>
...
export default {
  ...
  computed: {
    toFix() {
      let value = parseFloat(this.product_data.price);
